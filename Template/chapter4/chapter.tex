...
\item \textit{Typical Hours}: numerical variable describing the typical amount of work (in terms of number of hours) for hourly employees. For salary employees the attribute value is null.
